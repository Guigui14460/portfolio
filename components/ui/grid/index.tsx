...
const GridWrapper = styled.div<{ padding: GridGap, columnClassName: string, rowClassName: string }>`
    &.${props => props.columnClassName} {
        padding-left: ${({ padding }) => padding};
        padding-right: ${({ padding }) => padding};
    }

    &.${props => props.columnClassName} > .${props => props.rowClassName} {
...
const Grid: FunctionComponent<GridProps> = props => {
  ...
  return <GridWrapper padding={padding} style={style} className={classes} columnClassName={styles["column"]} rowClassName={styles["row"]}>{children}</GridWrapper>;
};
