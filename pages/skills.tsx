...
import { Tab, TabPanel } from '@/components/ui/tabs/index';
import Accordion from '@/components/ui/accordion';
import { skillsTabData } from '@/models/Skill';
import hardSkillData from "@/data/skillsData";
...
const SkillsPage = () => {
    ...
    useEffect(()=>{
      ...
      if(hash !== undefined){
        setId(annualProjectIds.indexOf(hash))
      }
    }, [ asPath ]);
    
    return <>
      <PageMetaTags pagePath='/skills' title="Skills" />
        ...
        <Grid row style={{ textAlign: "center" }}>
          <Grid column sm={12} md={6} lg={3}>
            ...
            <p className='justify'>I am a person who is always motivated when I undertake any kind of activity. Motivation is one of the most useful skills in our daily life, it allows us to continue and get closer to our goals.<br />
                You can see <Link className='link' href="/about#sentences">my sentences</Link> to understand how important this skill is to me.</p>
          </Grid>
          <Grid column sm={12} md={6} lg={3}>
      ...
      <section>
        ...
        <Accordion title='Annual project 2nd year of MSc' id="annual-project-m2" isOpen={id === annualProjectIds.indexOf("annual-project-m2")}>
          <>
            <h4><Link href="/documents/annual_project_report_5th_year.pdf" className="link">Automatic segmentation of soft tissue flaps by artificial intelligence for postoperative radiotherapy of head and neck cancer patients</Link></h4>
            <p className="justify">
